...
kTssTaskSelector           	=$-gdtNullDescriptor			;72
kTssTaskDescriptor         	dq 0000e90000000000h
...
kTssV86Selector				=$-gdtNullDescriptor			;104
kTssV86Descriptor			dq 0000e90000000000h

ldtSelector             	=$-gdtNullDescriptor			;112
ldtDescriptor           	dq 0000e20000000000h

callGateSelector            =$-gdtNullDescriptor			;120
callGateDescriptor      	dq 0000ec0000000000h

;32位测试段
eoCode32Seg           		=$ - gdtNullDescriptor			;128
eoCode32Descriptor         	dq 00cf98000000ffffh	
roData32Seg           		=$ - gdtNullDescriptor			;136
...
_tssException 		TASKSTATESEG <0>		;tss exception
_tssTimer 			TASKSTATESEG <0>		;task switch
